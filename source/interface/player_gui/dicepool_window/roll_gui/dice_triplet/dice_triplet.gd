...
# preload vatiables
var ISide = preload("res://interface/player_gui/info_display/dice_info/sides/iside/iside.tscn")
var DiceFrame = preload("res://interface/player_gui/info_display/dice_frame/dice_frame.tscn")
