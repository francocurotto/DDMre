...
# preloads
const RaiseAttackButton = preload("res://interface/player_gui/dungeon_window/dungeon_gui/attack_menu/raise_attack_gui/raise_attack_button/raise_attack_button.tscn")
