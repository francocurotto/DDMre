...
# preloads
const RaiseAttackButton = preload("res://interface/player_gui/dungeon_window/dungeon_gui/attack_menu/attack_ability_interfaces/raise_attack_interface/raise_attack_button.tscn")
