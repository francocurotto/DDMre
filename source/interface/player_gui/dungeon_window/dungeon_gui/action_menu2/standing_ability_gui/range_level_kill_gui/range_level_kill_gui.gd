...
# constants
const RangeLevelKillSelectTileGUI = preload("res://interface/player_gui/dungeon_window/dungeon_gui/action_menu2/standing_ability_gui/range_level_kill_gui/select_tile_gui.tscn")
