...
# constants
const AttackGUI = preload("res://interface/player_gui/dungeon_window/dungeon_gui/action_menu/attack_gui/attack_gui.tscn")
const ReplyGUI = preload("res://interface/player_gui/dungeon_window/dungeon_gui/action_menu/reply_gui/reply_gui.tscn")
const StandingAbilityGUI = preload("res://interface/player_gui/dungeon_window/dungeon_gui/action_menu/standing_ability_gui/standing_ability_gui.tscn")
const StateAbilityGUI = preload("res://interface/player_gui/dungeon_window/dungeon_gui/action_menu/state_ability_gui/state_ability_gui.tscn")
