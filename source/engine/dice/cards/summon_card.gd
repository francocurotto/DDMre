...
const BuffType = preload("res://engine/abilities/buff_type.gd")
const ProtectType = preload("res://engine/abilities/protect_type.gd")
const Frozen = preload("res://engine/abilities/frozen.gd")
const MoveLimit = preload("res://engine/abilities/move_limit.gd")
const RaiseSpeed = preload("res://engine/abilities/raise_speed.gd")
const RaiseAttack = preload("res://engine/abilities/raise_attack.gd")
