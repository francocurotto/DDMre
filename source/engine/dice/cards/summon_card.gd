...
const DimAddCrest = preload("res://engine/abilities2/dimension_abilities/dim_add_crest.gd")
const Exodia = preload("res://engine/abilities2/dimension_abilities/exodia.gd")
const DimBuffDeadType = preload("res://engine/abilities2/dimension_abilities/dim_buff_dead_type.gd")
const StopFly = preload("res://engine/abilities2/continuous_abilities/stop_fly.gd")
const StopTunnel = preload("res://engine/abilities2/continuous_abilities/stop_tunnel.gd")
const TurnSlowType = preload("res://engine/abilities2/continuous_abilities/turn_slow_type.gd")
const BuffType = preload("res://engine/abilities2/continuous_abilities/buff_type.gd")
const ProtectType = preload("res://engine/abilities2/continuous_abilities/protect_type.gd")
...
const ItemDamage = preload("res://engine/abilities2/manual_item_abilities/item_damage.gd")
const TimeMachine = preload("res://engine/abilities2/manual_item_abilities/time_machine.gd")
const ItemBuff = preload("res://engine/abilities2/manual_item_abilities/item_buff.gd")
const ItemCrestKill = preload("res://engine/abilities2/manual_item_abilities/item_crest_kill.gd")
const BlackHole = preload("res://engine/abilities2/manual_item_abilities/black_hole.gd")
const Gluminizer = preload("res://engine/abilities2/dimension_item_abilities/gluminizer.gd")
const WarpVortex = preload("res://engine/abilities2/dimension_item_abilities/warp_vortex.gd")
