...
const ABILITY_DICT = {
    ...
    "ITEMCURE"         : preload("res://engine/abilities/manual_item_abilities/item_cure.gd"),
    "ITEMDAMAGE"       : preload("res://engine/abilities/manual_item_abilities/item_damage.gd"),
    "TIMEMACHINE"      : preload("res://engine/abilities/manual_item_abilities/time_machine.gd"),
    "ITEMBUFF"         : preload("res://engine/abilities/manual_item_abilities/item_buff.gd"),
    "ITEMCRESTKILL"    : preload("res://engine/abilities/manual_item_abilities/item_crest_kill.gd"),
    "MONSTERREBORN"    : preload("res://engine/abilities/manual_item_abilities/monster_reborn.gd"),
    "BLACKHOLE"        : preload("res://engine/abilities/manual_item_abilities/black_hole.gd"),
    "GLUMINIZER"       : preload("res://engine/abilities/dimension_item_abilities/gluminizer.gd"),
    "WARPVORTEX"       : preload("res://engine/abilities/dimension_item_abilities/warp_vortex.gd"),
}
