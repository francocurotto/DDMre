...
const ABILITY_DICT = {
    ...
    "ITEMCURE"         : preload("res://engine/abilities/item_abilities/item_auto_abilities/item_cure.gd"),
    "ITEMDAMAGE"       : preload("res://engine/abilities/item_abilities/item_auto_abilities/item_damage.gd"),
    "TIMEMACHINE"      : preload("res://engine/abilities/item_abilities/item_auto_abilities/time_machine.gd"),
    "ITEMBUFF"         : preload("res://engine/abilities/item_abilities/item_auto_abilities/item_buff.gd"),
    "ITEMCRESTKILL"    : preload("res://engine/abilities/item_abilities/item_auto_abilities/item_crest_kill.gd"),
    "MONSTERREBORN"    : preload("res://engine/abilities/item_abilities/item_manual_abilities/monster_reborn.gd"),
    "BLACKHOLE"        : preload("res://engine/abilities/item_abilities/item_auto_abilities/black_hole.gd"),
